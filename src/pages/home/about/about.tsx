        ...
        <Row>
          <Col md={6}>
            <div className="about-text">
              ...
              <p>Hi, i'm Razib 😄</p>
              <p>
                ⚡️ A passionate 👨‍💻Full Stack Web & 📱Mobile developer employing
                the best practices across numerous tech stacks.
              </p>
              <p>
            ...
            <div className="about-summary">
              <p>
                ...
                impress my friends. But, over time, this obsession turned into a
                hobby and is now the <a href="">career</a> path that I have
                chosen. During this period, I had constantly been exposed to new
                technologies, leading me to work on several{" "}
                <a href="">projects</a> and collaborate with some great people.
                {/*                 
