      ...
      <Row>
        ...
        <Col md={5}>
          ...
          <p className={styles["project-description"]}>
            A autonomous stacking robot created using OpenCV And a Raspberry pi
            4 that moves around a environment in search of a colored bloak after
            which it picks it up and goes back to be stacked via a line
            follower.
          </p>
          <div className={styles["techstackssectiom"]}>
            ...
            <HoverListItem title={"DC Motors"} iconPath={Assets.DCMOTOR_ICON} />
